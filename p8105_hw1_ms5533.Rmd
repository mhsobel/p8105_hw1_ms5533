...
The data frame created has a size of "". The mean of "x" is equal to `r mean(prob2_df$x)` and the median of "x" is equal to `r median(prob2_df$x)`. `r sum(prob2_df$TF_num)`. 
